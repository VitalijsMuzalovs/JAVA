...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            // точка безубыточности = затраты проекта / чистая прибыль
            System.out.println( "====================");
            System.out.println( "Fixed Costs: " + calculateFixedCharges());
            System.out.println("Искомая точка безубыточноси: " + (calculateFixedCharges() * (1 + managerPercent)) / (1 - mainTaxPercent));
            if (pureIncome < 0) {
